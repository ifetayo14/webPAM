...
@section('main-content')
    <h3 style="text-align: center">TAMBAH DATA PESERTA</h3>
    <br>

    <div class="col-md-2"></div>
    <div class="col-md-8">
        <form class="form-horizontal" method="post" action="{{ url('/addNewPeserta') }}">
            @csrf
            ...
            <input type="hidden" class="form-control" id="role" name="role" value="peserta">
            <div class="form-group">
